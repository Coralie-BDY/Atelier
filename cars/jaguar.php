   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Clio 3 1.5 DCI 70</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Clio 3 1.5 DCI 70 </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 1790 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='clio3Champagne' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='clio3Champagne' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/clio3Champagne/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio3Champagne/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio3Champagne/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Sièges: Tissu crème</p>
                        <p>Jantes: Allu</p>
                        <p>Couleur de la peinture extérieure: Champagne</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Bon état</p>
                        <p>Intérieur: Bon état</p>
                        <p>Précisions sur les défauts de carrosserie : Quelques rayures sur le parechoc arrière, bosse sur l'aile droite</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Oui</p>
                        <p>Dernières réparations effectuées : Vidange, batterie neuve, bougies neuves</p>
                        <p>** Distribution effectuée ? **  Oui</p>
                        <p>Le date non précisée</p>
                     ...
                     <div id='tab2' class='tabcontent'>
                        ...
                        <table class='table table-bordered'>
                           <tbody>
                              <tr>
                                 <th scope='row'>Rétroviseurs électriques</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Prédisposition téléphone</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Volant multifonctions</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Affichage tête haute</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Volant réglable en hauteur</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Anti-démarrage</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Airbags rideaux</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Témoin de bouclage des ceintures AV</th>
                              </tr>
                           </tbody>
                        </table>
                     </div>
               ...
               <div class='col-md-4'>
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        <h5>DESCRIPTION</h5>
                        <ul>
                           <li> <span>Marque</span> <strong class='text-right'>Renault</strong></li>
                           <li> <span>Modèle</span> <strong class='text-right'>Clio 3</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.5 DCI 70</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>4</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>07/04/2006</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>250 000</strong></li>
                           <li> <span>Carburant</span> <strong class='text-right'>Diesel</strong></li>
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>Champagne</strong></li>
                           <li> <span>Couleur intérieure</span> <strong class='text-right'>Tissu crème</strong></li>
                        </ul>
                     </div>
         ...
         <div class='container'>
            ...
            <div class='row'>
               <div class='col-lg-3 col-md-6'>
                  ...
                  <div class='address'>
                     <ul>
                        <li> <i class='fa fa-map-marker'></i><span>29 avenue de Mantes </br> Rosny-sur-Seine 78710</span> </li>
               ...
               <div class='col-lg-3 col-md-6'>
                  <div class='usefull-link'>
                     ...
                     <ul>
                        <li><a href='#'><i class='fa fa-angle-double-right'></i> Vente de véhicules </a></li>
                        <li><a href='#'><i class='fa fa-angle-double-right'></i> Achat de véhicules</a></li>
                        <li><a href='#'><i class='fa fa-angle-double-right'></i> Préstations liées à la mécanique</a></li>
                        <li><a href='#'><i class='fa fa-angle-double-right'></i> Devis pour achat de véhicule </a></li>
                        <li><a href='#'><i class='fa fa-angle-double-right'></i> Devis pour réparation de véhicule</a></li>
                     </ul>
                  </div>
               </div>
               <div class='col-lg-3 col-md-6'>
                  <div class='recent-post-block'>
                     ...
                     <div class='recent-post'>
                        <div class='recent-post-image'><img class='img-fluid' src='images/car/01.jpg' alt=''> </div>
                        <div class='recent-post-info'><a href='#'>Salon de l'auto</a><span class='post-date'><i class='fa fa-calendar'></i>10 Septembre 2017</span></div>
                     </div>
                     <div class='recent-post'>
                        <div class='recent-post-image'><img class='img-fluid' src='images/car/02.jpg' alt=''> </div>
                        <div class='recent-post-info'><a href='#'>Classiques des 80's </a><span class='post-date'><i class='fa fa-calendar'></i>10 Septembre 2017</span></div>
                     </div>
                     <div class='recent-post'>
                        <div class='recent-post-image'><img class='img-fluid' src='images/car/03.jpg' alt=''> </div>
                        <div class='recent-post-info'><a href='#'>'Avoir un joint de culasse?' </a><span class='post-date'><i class='fa fa-calendar'></i>10 Septembre 2017</span></div>
                     </div>
                  </div>
               </div>
               <div class='col-lg-3 col-md-6'>
                  <div class='news-letter'>
                     ...
                     <form class='news-letter'><input type='email' placeholder='Entrez votre courriel' class='form-control placeholder'><a class='button red' href='#'>S'inscrire</a></form>
                  </div>
               </div>
            </div>
            <hr />
