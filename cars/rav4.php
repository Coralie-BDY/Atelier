   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Toyota RAV4 2.2 D-4D Clean Power</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Toyota RAV4 2.2 D-4D Clean Power </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 7900 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='rav4' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='rav4' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/rav4/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/rav4/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/rav4/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/rav4/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Précisions sur les défauts de carrosserie : Quelques éraflures sur l'aile arrière droite</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Oui</p>
                        <p>Dernières réparations effectuées : Révision complète des 140 000km</p>
                        <p>** Distribution effectuée ? **  Moteur à chaîne</p>
                        <p>Le Le moteur est à chaîne</p>
                     ...
                     <div id='tab2' class='tabcontent'>
                        ...
                        <table class='table table-bordered'>
                           <tbody>
                              <tr>
                                 <th scope='row'>Allumage automatique des feux</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Rétroviseurs électriques</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Rétroviseurs dégivrants</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Vitres électriques</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Vitres surteintées</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Reconnaissance vocale</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Accoudoir central</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Climatisation automatique</th>
                              </tr>
                              <tr>
                                 <th scope='row'>ABS</th>
                              </tr>
                              ...
                              <tr>
                                 <th scope='row'>Détecteur de pluie</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Limiteur de vitesse</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Régulateur de vitesse</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Contrôle de pression des pneus</th>
                              </tr>
                           </tbody>
                        </table>
                     </div>
               ...
               <div class='col-md-4'>
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        <h5>DESCRIPTION</h5>
                        <ul>
                           <li> <span>Marque</span> <strong class='text-right'>Toyota</strong></li>
                           <li> <span>Modèle</span> <strong class='text-right'>RAV4 Clean Power</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>2.2 D-4D</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>8</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>03/2010</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>140000</strong></li>
