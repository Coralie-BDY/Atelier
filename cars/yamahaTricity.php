         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Yamaha Tricity 125</h1>
               </div>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='yamahaTricity' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='yamahaTricity' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/yamahaTricity/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/yamahaTricity/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/yamahaTricity/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Contrôle technique effectué: Non</p>
                        <h3 style='font-size: 14px;'>- Caractéristiques intérieures et extérieures du véhicule</h3>
                        <p>Sièges: selle noire</p>
                        <p>Jantes: allu</p>
                        <p>Couleur de la peinture extérieure: gris mate</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Bon état général</p>
                        <p>Intérieur: Bon état général</p>
                        <p>Précisions sur les défauts de carrosserie : Rayures superficielles</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Tout l'entretien disponible</p>
                        <p>Dernières réparations effectuées : Vidange complète</p>
               ...
               <div class='col-md-4'>
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        <h5>DESCRIPTION</h5>
                        <ul>
                           <li> <span>Marque</span> <strong class='text-right'>Yamaha</strong></li>
                           <li> <span>Modèle</span> <strong class='text-right'>Tricity</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>NAN</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>125</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>1</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>28/07/2015</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>23000</strong></li>
                           <li> <span>Carburant</span> <strong class='text-right'>Essence</strong></li>
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>gris mate</strong></li>
                           <li> <span>Couleur intérieure</span> <strong class='text-right'>selle noire</strong></li>
                        </ul>
                     </div>
