   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Peugeot 206 + 1.1 Urban</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Peugeot 206 + 1.1 Urban </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 3390 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='206Urban2011' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='206Urban2011' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/206Urban2011/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/206Urban2011/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/206Urban2011/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/206Urban2011/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Jantes: Allu</p>
                        <p>Couleur de la peinture extérieure: Noir metallic</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Bon état général</p>
                        <p>Intérieur: Bon état général</p>
                        <p>Précisions sur les défauts de carrosserie : Quelques rayures superficielles</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Oui</p>
                        <p>Dernières réparations effectuées : Vidange et distribution complètes</p>
                  ...
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        ...
                        <ul>
                           ...
                           <li> <span>Modèle</span> <strong class='text-right'> 206 + Urban</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.1</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>5</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>09/11/2010</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>115 000</strong></li>
                           <li> <span>Carburant</span> <strong class='text-right'>Essence</strong></li>
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>Noir metallic</strong></li>
