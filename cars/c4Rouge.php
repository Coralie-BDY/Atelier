   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Citröen c4 1.6 HDI</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Citröen c4 1.6 HDI </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 1890 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='c4Rouge' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='c4Rouge' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/c4Rouge/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c4Rouge/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/c4Rouge/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c4Rouge/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Sièges: Tissu noir et gris</p>
                        <p>Jantes: Tôles</p>
                        <p>Couleur de la peinture extérieure: Rouge</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Moyen</p>
                        <p>Intérieur: Bon état général</p>
                        <p>Précisions sur les défauts de carrosserie : Peinture terni sur le capot et la porte avant droite</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Oui</p>
                        <p>Dernières réparations effectuées : Vidange, disques et plaquettes</p>
                        <p>** Distribution effectuée ? **  Kit de distrib offert</p>
                        <p>Le kit de distribution est offert lors de l'achat du véhicule</p>
                     ...
                     <div id='tab2' class='tabcontent'>
                        ...
                        <table class='table table-bordered'>
                           <tbody>
                              ...
                              <tr>
                                 <th scope='row'>Fermeture automatique des portes</th>
                              </tr>
                              <tr>
                  ...
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        ...
                        <ul>
                           ...
                           <li> <span>Modèle</span> <strong class='text-right'>c4</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.6 HDI 92</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>5</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>22/05/2008</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>220 000</strong></li>
                           <li> <span>Carburant</span> <strong class='text-right'>Essence</strong></li>
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>Rouge</strong></li>
                           <li> <span>Couleur intérieure</span> <strong class='text-right'>Tissu noir et gris</strong></li>
                        </ul>
                     </div>
