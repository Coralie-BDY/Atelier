   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>C1 1.0 VTi 68 Feel</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> C1 1.0 VTi 68 Feel </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 7990 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='c12017' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='c12017' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/c12017/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c12017/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/c12017/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c12017/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Contrôle technique effectué: Véhicule de - 6 mois</p>
                        <h3 style='font-size: 14px;'>- Caractéristiques intérieures et extérieures du véhicule</h3>
                        <p>Sièges: Tissu noir</p>
                        <p>Jantes: Tôles</p>
                        <p>Couleur de la peinture extérieure: blanc</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Parfait état</p>
                        <p>Intérieur: Parfait état</p>
                        <p>Précisions sur les défauts de carrosserie : Pas de défaut de carrosserie</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Oui</p>
                        <p>Dernières réparations effectuées : Révision et vidange avec disques et plaquettes avant neufs</p>
                        <p>** Distribution effectuée ? **  Non</p>
                        <p>Le véhicule a seulement 36 000km</p>
                     ...
                     <div id='tab2' class='tabcontent'>
                        ...
                        <table class='table table-bordered'>
                           <tbody>
                              ...
                              <tr>
                                 <th scope='row'>Semi LED</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Peinture intégrale</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Radar de stationnement détection arrière</th>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th scope='row'>Aide au démarrage en pente</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Climatisation manuelle</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Pack Electrique</th>
                              </tr>
                              <tr>
                                 <th scope='row'>ABS</th>
                              </tr>
                              ...
                              <tr>
                                 <th scope='row'>Répartiteur électronique de freinage</th>
                              </tr>
                              <tr>
                                 <th scope='row'>Pack Color Feel</th>
                              </tr>
                              <tr>
               ...
               <div class='col-md-4'>
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        <h5>DESCRIPTION</h5>
                        <ul>
                           <li> <span>Marque</span> <strong class='text-right'>Citröen</strong></li>
                           <li> <span>Modèle</span> <strong class='text-right'>C1</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.0</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>4</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>27/10/2016</strong></li>
                           ...
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>blanc</strong></li>
