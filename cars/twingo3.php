   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Twingo 3 1.0 SCe 71 cv</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Twingo 3 1.0 SCe 71 cv </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 7590 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='twingo3' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='twingo3' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/twingo3/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/twingo3/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/twingo3/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/twingo3/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Contrôle technique effectué: Pas de contrôle technique à prévoir en dessous de 4 ans</p>
                        <h3 style='font-size: 14px;'>- Caractéristiques intérieures et extérieures du véhicule</h3>
                        <p>Sièges: Tissu gris foncé</p>
                        <p>Jantes: Tôles</p>
                        <p>Couleur de la peinture extérieure: Blanc</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Neuf</p>
                        <p>Intérieur: Neuf</p>
                        <p>Précisions sur les défauts de carrosserie : Carrosserie parfaite</p>
                  ...
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        ...
                        <ul>
                           ...
                           <li> <span>Modèle</span> <strong class='text-right'>Twingo 3</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.0 SCe eco2 S&S</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>4</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>06/2016</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>15000</strong></li>
                           ...
                           <li> <span>Couleur intérieure</span> <strong class='text-right'>Tissu gris foncé</strong></li>
                        </ul>
                     </div>
