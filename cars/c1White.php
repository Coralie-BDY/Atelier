   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Citröen c1 1.0 Attraction</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Citröen c1 1.0 Attraction </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 3490 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='c1White' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='c1White' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/c1White/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/c1White/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/c1White/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/c1White/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Précisions sur les défauts de carrosserie : Quelques rayures superficielles sur le parchoc avant</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Vidange complète</p>
                        <p>Dernières réparations effectuées : Vidange et roulement arrière droit</p>
               ...
               <div class='col-md-4'>
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        <h5>DESCRIPTION</h5>
                        <ul>
                           <li> <span>Marque</span> <strong class='text-right'>Citroën</strong></li>
                           <li> <span>Modèle</span> <strong class='text-right'>c1 Attraction</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.0</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>Tissu noir</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>11/2011</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>80 000</strong></li>
