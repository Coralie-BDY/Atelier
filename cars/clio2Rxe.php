         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Clio 2 1.2 RXE</h1>
               </div>
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       ...
                                       <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                          <input type='hidden' name='action' value='schedule_test_drive' /><input type='hidden' name='reference' value='clio2Rxe' />
                                 ...
                                 <div class='modal-content'>
                                    ...
                                    <div class='modal-body'>
                                       <form class='gray-form reset_css' action='' id='makeOfferForm'>
                                          <input type='hidden' name='action' value='make_an_offer' /><input type='hidden' name='reference' value='clio2Rxe' />
            ...
            <div class='row'>
               <div class='col-md-8'>
                  <div class='slider-slick'>
                     <div class='slider slider-for detail-big-car-gallery'> <img class='img-fluid' src='../images/detail/big/clio2Rxe/1.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/2.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/3.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/4.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/5.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/6.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/7.jpg' alt=''><img class='img-fluid' src='../images/detail/big/clio2Rxe/8.jpg' alt=''></div>
                     <div class='slider slider-nav'> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/1.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/2.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/3.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/4.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/5.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/6.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/7.jpg' alt=''> <img class='img-fluid' src='../images/detail/thum/clio2Rxe/8.jpg' alt=''> </div>
                  </div>
                  <div id='tabs'>
                     <ul class='tabs'>
                     ...
                     <div id='tab1' class='tabcontent'>
                        ...
                        <p>Nombre de propriétaires: 3</p>
                        <p>Double des clefs: Oui</p>
                        <p>Contrôle technique effectué: Oui, moins de 3 mois</p>
                        <h3 style='font-size: 14px;'>- Caractéristiques intérieures et extérieures du véhicule</h3>
                        <p>Sièges: Tissu bleu</p>
                        <p>Jantes: Tôles</p>
                        <p>Couleur de la peinture extérieure: Bleu metallic</p>
                        <h3 style='font-size: 14px;'>- Etat général</h3>
                        <p>Extérieur: Etat moyen</p>
                        <p>Intérieur: Bon état général</p>
                        <p>Précisions sur les défauts de carrosserie : Décoloration du toit, une porte avec peinture partiellement décolorée</p>
                        <h3 style='font-size: 14px;'>- Entretien effectué</h3>
                        <p>Carnet d'entretien disponible : Oui</p>
                        <p>Dernières réparations effectuées : Kit de distribution, culasse et vidange complète</p>
                  ...
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        ...
                        <ul>
                           ...
                           <li> <span>Modèle</span> <strong class='text-right'>Clio 2 RXE</strong></li>
                           <li> <span>Boite</span> <strong class='text-right'>Manuelle</strong></li>
                           <li> <span>Moteur</span> <strong class='text-right'>1.2</strong></li>
                           <li> <span>Chevaux fiscaux</span> <strong class='text-right'>4</strong></li>
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>09/2000</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>93000</strong></li>
                           <li> <span>Carburant</span> <strong class='text-right'>Essence</strong></li>
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>Bleu metallic</strong></li>
                           <li> <span>Couleur intérieure</span> <strong class='text-right'>Tissu bleu</strong></li>
                        </ul>
                     </div>
