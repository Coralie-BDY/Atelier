   ...
   <body>
         ...
         <div class='container'>
            <div class='row text-center intro-title'>
               <div class='col-md-6 text-md-left d-inline-block'>
                  <h1 class='text-white'>Citroën C1 1.0 Attraction</h1>
               </div>
      ...
      <section class='car-details page-section-ptb'>
         <div class='container'>
            <div class='row'>
               <div class='col-md-9'>
                  <h3> Citroën C1 1.0 Attraction </h3>
               </div>
               <div class='col-md-3'>
                  <div class='car-price text-lg-right'><strong> 4590 €</strong><span>TTC</span></div>
               </div>
            </div>
            <div class='row'>
               <div class='col-md-12'>
                  ...
                  <div class='car-details-sidebar'>
                     <div class='details-block details-weight'>
                        ...
                        <ul>
                           ...
                           <li> <span>1ère immatriculation </span> <strong class='text-right'>03/2012</strong></li>
                           <li> <span>Kilométrage</span> <strong class='text-right'>60000</strong></li>
                           <li> <span>Carburant</span> <strong class='text-right'>Essence</strong></li>
                           <li> <span>Couleur extérieure</span> <strong class='text-right'>Rouge mettalic</strong></li>
