                            ...
                            $window.on('scroll', function () {
                                if ($window.scrollTop() > settings.sticky_header_height) {
                                    ...
                                    if (scrollFlag === true) {
                                        ...
                                        // Resize of the company name on scroll down in menu nav bar
                                        $("#company-name").css({"height":"0px","font-size":"12px","position":"relative","top":"-14px"});
                                    ...
                                    if (scrollFlag === false) {
                                        ...
                                        // Resize of the company name on scroll down in menu nav bar
                                        $("#company-name").css({"height":"0px","font-size":"16px","position":"relative","top":"0"});
                                        // scroll flag true
                                        scrollFlag = true;
                                    }
                                }
